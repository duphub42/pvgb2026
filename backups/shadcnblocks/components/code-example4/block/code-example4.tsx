...
interface CodeExample4Props {
  className?: string;
}

const CodeExample4 = ({ className }: CodeExample4Props) => {
    ...
    <section className={cn("py-32", className)}>
      <div className="container">
        <div className="mb-12 text-center">
          <span className="mb-6 text-xs text-muted-foreground uppercase">
            Component Library
          </span>
        ...
        <div className="grid lg:grid-cols-[300px_1fr]">
          {/* File Tree */}
          <div className="rounded-t-lg border border-b-0 bg-muted/20 p-4 lg:rounded-l-lg lg:rounded-tr-none lg:border-r-0 lg:border-b">
            <TreeProvider
          ...
          <div className="min-h-0 min-w-0 overflow-hidden">
            <CodeBlock
              ...
              className="h-full w-full rounded-t-none rounded-b-lg lg:rounded-l-none lg:rounded-r-lg lg:rounded-bl-none"
            >

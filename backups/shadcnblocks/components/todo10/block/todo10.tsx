  ...
  return (
    <div ref={setNodeRef} style={style} className="w-full">
      <Item
        ...
        className={cn(
          "group cursor-pointer items-start rounded-none border-0 border-b border-border",
          ...
          <div className="flex items-center gap-0.5">
            <div className="relative flex items-center">
              ...
              <Button
                ...
                {...listeners}
                className={cn(
                  "absolute -translate-x-1 scale-50 cursor-grab opacity-0 transition-all group-hover:translate-x-0 group-hover:scale-100 group-hover:opacity-100 active:cursor-grabbing",
              ...
              >
                <div className="mt-1.5 space-y-0.5">
                  {todo.subtasks.map((subtask) => (
                    <div
                      key={subtask.id}
                      className="group/subtask -ml-1 flex items-center gap-1.5 rounded px-1 py-0.5 transition-colors hover:bg-accent/20"
                      onClick={(e) => {
                        e.stopPropagation();
                ...
                {filteredCompletedTodos.length > 0 && (
                  <div className="space-y-3 border-t border-border/50 pt-6">
                    <button
                      ...
                      className="group flex w-full items-center gap-2 text-xs font-semibold tracking-wider text-muted-foreground uppercase transition-colors hover:text-foreground"
                    >
                      <ChevronDown
                        className={cn(

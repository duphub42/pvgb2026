...
export const DataTable3 = ({ className }: { className?: string }) => {
        ...
        <div className="w-full">
          <div className="mb-8 text-left">
            ...
            <p className="mt-2 text-muted-foreground">
              Data table with alternating row colors for improved readability.
              Features a highlighted header and zebra-striped pattern for better
              data scanning.
            </p>
          </div>

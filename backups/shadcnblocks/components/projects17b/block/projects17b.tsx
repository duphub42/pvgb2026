    ...
    <section className={cn("py-16", className)}>
      <div className="w-full">
        ...
        <div className="relative w-full">
          ...
          <div className="pointer-events-none absolute inset-y-0 top-60 right-0 left-0 z-10 flex justify-between px-8">
            <Button
              size="icon"
              variant="outline"
              onClick={() => carouselApi?.scrollPrev()}
              disabled={!canScrollPrev}
              className="pointer-events-auto h-10 w-10 rounded-full border-gray-200 bg-white/90 shadow-lg hover:bg-white"
            >

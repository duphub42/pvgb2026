...
const ProductQuickView6 = ({
  ...
  return (
    <Sheet defaultOpen>
      <SheetContent className="w-full max-md:!max-w-[calc(100dvw-3rem)] sm:!max-w-200 md:!max-w-200 lg:!max-w-240 [&>button]:hidden">
        ...
        <div className="h-full p-4 max-md:overflow-auto md:p-6">
          <div className="flex h-full gap-6 max-md:flex-col lg:gap-10">
            ...
            <div className="h-full basis-7/12 pb-10">
              <div className="hide-scrollbar h-full overflow-auto md:mt-2">

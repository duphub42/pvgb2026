  ...
  return (
    <section className={cn("py-32", className)}>
      <div className="container mx-auto">
        <h2 className="mb-8 max-w-4xl text-4xl font-medium tracking-tighter text-foreground md:text-5xl lg:mb-16">
          Our blocks are used by the world's best product teams.
        </h2>

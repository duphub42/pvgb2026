...
export const DataTable9 = ({ className }: { className?: string }) => {
        ...
        <div className="w-full">
          <div className="mb-8 text-left">
            <h2 className="text-2xl font-bold tracking-tight">
              Data Table With Global Filter
            </h2>
            <p className="mt-2 text-muted-foreground">
              A feature-rich data table with sorting and global filtering
              capabilities, full pagination controls with responsive design.
            </p>
          </div>
          {Toolbar}

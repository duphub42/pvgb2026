...
export type TextAnimateType = 'text' | 'word' | 'character' | 'line'
...
const staggerTimings: Record<TextAnimateType, number> = {
  text: 0.06,
  word: 0.05,
  character: 0.03,
  line: 0.06,
  ...
  scaleUp: {
    ...
    item: {
      ...
      show: {
        ...
        transition: {
          duration: 0.3,
          scale: { type: 'spring' as const, damping: 15, stiffness: 300 },
        },
      },
...
const TextAnimateBase = ({
  ...
  const stagger = segments.length > 0 ? duration / segments.length : staggerTimings[by]

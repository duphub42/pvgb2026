...
async function restoreLegalPages() {
  const payload = await getPayload({ config })

  // Check if pages exist
  const impressumCheck = await payload.find({
    collection: 'site-pages',
    where: { slug: { equals: 'impressum' } },
    limit: 1,
  })

  const datenschutzCheck = await payload.find({
    collection: 'site-pages',
  ...
  if (impressumCheck.docs.length > 0) {
    await payload.delete({
      collection: 'site-pages',
      id: impressumCheck.docs[0].id,
    })
    console.log('Deleted existing Impressum')
  }

  if (datenschutzCheck.docs.length > 0) {
    await payload.delete({
      collection: 'site-pages',
      id: datenschutzCheck.docs[0].id,
    })
    console.log('Deleted existing Datenschutz')
  }
                ...
                root: {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Händelstr. 3, D-06114 Halle/Saale', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Telefon: +49 3459 6393323 | E-Mail: mail@philippbacher.com', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV', version: 1 }],
                    },
                    {
                      type: 'paragraph',
                      direction: 'ltr',
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Philipp Bacher, Händelstr. 3', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Umsatzsteuer-Identifikationsnummer gemäß § 27a UStG: DE337118461', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Verbraucherstreitbeilegung', version: 1 }],
                    },
                    {
                      type: 'paragraph',
                      direction: 'ltr',
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Die durch den Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Beiträge Dritter sind als solche gekennzeichnet. Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers.', version: 1 }],
                    },
                    {
                      type: 'paragraph',
                      direction: 'ltr',
  ...
  console.log('Impressum created successfully')
                ...
                root: {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Philipp Bacher, Händelstr. 3, D-06114 Halle/Saale. Telefon: +49 3459 6393323 | E-Mail: mail@philippbacher.com', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Beim Aufruf der Website werden technisch erforderliche Daten verarbeitet (z.B. IP-Adresse, Datum/Uhrzeit des Zugriffs, angeforderte URL). Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse).', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Sie haben Recht auf Auskunft (Art. 15), Berichtigung (Art. 16), Löschung (Art. 17), Einschränkung (Art. 18), Datenübertragbarkeit (Art. 20), Widerspruch (Art. 21) und Widerruf (Art. 7 Abs. 3 DSGVO).', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                    ...
                    },
                    {
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: 'Sie können sich bei einer Datenschutz-Aufsichtsbehörde beschweren.', version: 1 }],
                    },
                    {
                      type: 'heading',
                      tag: 'h2',
                      ...
                      indent: 0,
                      version: 1,
                      children: [{ type: 'text', text: '6. Änderungen', version: 1 }],
                    },
                    {
                      type: 'paragraph',
                      direction: 'ltr',
  ...
  console.log('Datenschutz created successfully')

  process.exit(0)
}

restoreLegalPages().catch((err) => {

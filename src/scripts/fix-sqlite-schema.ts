...
function main() {
  ...
  const steps: { name: string; sql: string }[] = [
    ...
    { name: 'site_pages_blocks_consulting_overview: layout_mode', sql: "ALTER TABLE site_pages_blocks_consulting_overview ADD COLUMN layout_mode TEXT DEFAULT 'standard';" },
    ...
    { name: '_site_pages_v_blocks_consulting_overview: layout_mode', sql: "ALTER TABLE _site_pages_v_blocks_consulting_overview ADD COLUMN layout_mode TEXT DEFAULT 'standard';" },
